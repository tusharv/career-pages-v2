        ...
        <div className="mx-auto mt-10 grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 md:gap-5 lg:gap-8">
          ...
          <div className="flex h-full flex-col rounded-xl border border-border/70 bg-muted/15 p-5 md:p-6">
            ...
            <Link
              ...
              aria-label="Career Pages on GitHub (open source repository)"
          ...
          {/* Stack — column 3 */}
          <div className="flex h-full flex-col rounded-xl border border-border/70 bg-muted/15 p-0 md:p-0">
            <details className="group flex h-full flex-col overflow-hidden rounded-xl text-sm">
              <summary className="cursor-pointer list-none px-5 py-5 font-medium text-foreground transition-colors marker:content-none hover:bg-muted/40 md:px-6 md:py-6 [&::-webkit-details-marker]:hidden">
                <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                  Built with
                </span>
                <span className="mt-2 block text-sm font-normal leading-snug text-muted-foreground">
                  shadcn/ui, Vercel, v0, Supabase
                  <span className="mt-1 block text-xs text-muted-foreground/80 group-open:hidden">
                    Tap to expand stack links
                  </span>
                </span>
              </summary>
              <div className="flex flex-1 flex-wrap items-center gap-x-2 gap-y-1.5 border-t border-border/60 px-5 py-4 text-muted-foreground md:px-6">
                <Link
